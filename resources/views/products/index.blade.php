...
@section('header_right')
    <a href="{{ route('products.create') }}" class="btn btn-md btn-neutral text-dark">
        <span class="btn-inner--icon mr-2"><i class="fas fa-plus"></i></span>
        Create New
    </a>
    <a href="#" class="btn btn-md btn-neutral text-dark" data-toggle="modal" data-target="#modalImportProduct">
        <span class="btn-inner--icon mr-2"><i class="fas fa-upload"></i></span>
        Import
    </a>
    @include('shared.modal_import_product')
@stop
...
@section('scripts')
    ...
    <script>
        var DatatableList = (function () {
            ...
            function init($this) {
                var ajax_url = '/retrieve_list/products'
