...
@section('header_right')
    <a href="{{ route('product_sales.create') }}" class="btn btn-md btn-neutral text-dark">
                ...
                <div class="card-wrapper">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h3 class="mb-0 font-weight-900">Product Sale - Data List</h3>
                        </div>
...
@section('scripts')
    ...
    <script>
        var DatatableList = (function () {
            ...
            function init($this) {
                var ajax_url = '/retrieve_list/product_sales'
