<div class="modal fade" id="modalImportProduct" tabindex="-1" role="dialog"
     aria-labelledby="modalImportProductLabel"
     aria-hidden="true">
            ...
            <form method="post"
                ...
                <div class="modal-body my-0">
                    <div class="text-left">
                        ...
                        <h5 class="modal-title" id="modalImportProductLabel">Import Product</h5>
                    </div>
                ...
                <div class="modal-footer pb-3 pt-0 d-block text-center">
                    <input type="hidden" name="import_action" value="import_products">
